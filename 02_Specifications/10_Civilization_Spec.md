# HISTORIUM — CIVILIZATION SPECIFICATION
...
Una civilización es una forma de vida histórica completa: territorio, memoria, instituciones, cultura, conflicto y legado.

En Historium, una civilización no existe como dato aislado.
...
Definir cómo se crea, valida, relaciona, versiona y publica una entidad de tipo civilización dentro del Canon Oficial.
...
Toda entidad de tipo civilización debe definir cómo progresa dentro del Museo.
...
Toda civilización debe conectarse al Grafo Histórico.
...
Una civilización solo entra al Canon si hace crecer el Museo Vivo del jugador.
