# HISTORIUM — LOCATION SPECIFICATION
...
Un lugar es una coordenada narrativa del Museo: punto físico, simbólico o estratégico de la Historia.

En Historium, una lugar no existe como dato aislado.
...
Definir cómo se crea, valida, relaciona, versiona y publica una entidad de tipo lugar dentro del Canon Oficial.
...
Toda entidad de tipo lugar debe definir cómo progresa dentro del Museo.
...
Toda lugar debe conectarse al Grafo Histórico.
...
Una lugar solo entra al Canon si hace crecer el Museo Vivo del jugador.
