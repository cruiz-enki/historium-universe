# HISTORIUM — EMPIRE SPECIFICATION
...
Un imperio organiza poder sobre múltiples pueblos, regiones y rutas durante un periodo significativo.

En Historium, una imperio no existe como dato aislado.
...
Definir cómo se crea, valida, relaciona, versiona y publica una entidad de tipo imperio dentro del Canon Oficial.
...
Toda entidad de tipo imperio debe definir cómo progresa dentro del Museo.
...
Toda imperio debe conectarse al Grafo Histórico.
...
Una imperio solo entra al Canon si hace crecer el Museo Vivo del jugador.
