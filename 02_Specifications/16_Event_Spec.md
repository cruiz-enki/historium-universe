...
Un evento es un punto de cambio verificable que altera personas, lugares, instituciones o ideas.

En Historium, una evento no existe como dato aislado.
...
Definir cómo se crea, valida, relaciona, versiona y publica una entidad de tipo evento dentro del Canon Oficial.
...
Toda entidad de tipo evento debe definir cómo progresa dentro del Museo.
...
Toda evento debe conectarse al Grafo Histórico.
...
Una evento solo entra al Canon si hace crecer el Museo Vivo del jugador.
