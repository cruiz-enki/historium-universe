# HISTORIUM — MONUMENT SPECIFICATION
...
Un monumento es memoria construida: arquitectura, poder, fe, propaganda y permanencia.

En Historium, una monumento no existe como dato aislado.
...
Definir cómo se crea, valida, relaciona, versiona y publica una entidad de tipo monumento dentro del Canon Oficial.
...
Toda entidad de tipo monumento debe definir cómo progresa dentro del Museo.
...
Toda monumento debe conectarse al Grafo Histórico.
...
Una monumento solo entra al Canon si hace crecer el Museo Vivo del jugador.
