# HISTORIUM — RELIGION SPECIFICATION
...
Una religión es un sistema de sentido que conecta ritual, comunidad, poder y visión del mundo.

En Historium, una religión no existe como dato aislado.
...
Definir cómo se crea, valida, relaciona, versiona y publica una entidad de tipo religión dentro del Canon Oficial.
...
Toda entidad de tipo religión debe definir cómo progresa dentro del Museo.
...
Toda religión debe conectarse al Grafo Histórico.
...
Una religión solo entra al Canon si hace crecer el Museo Vivo del jugador.
